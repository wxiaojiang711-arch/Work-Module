...
const RoleManagePage: React.FC = () => {
  ...
  const onSaveRole = (
    payload: Pick<RoleItem, "name" | "code" | "description" | "type" | "color" | "userCount" | "permissionModules" | "permissions">,
  ) => {
    if (formMode === "create") {
        ...
        <Row gutter={[12, 12]} align="middle">
          <Col span={8}>
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              <span style={{ whiteSpace: "nowrap" }}>角色名称：</span>
              <Input.Search
                allowClear
          ...
          <Col span={5}>
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              <span style={{ whiteSpace: "nowrap" }}>角色类型：</span>
              <Select
                style={{ width: "100%" }}
                value={query.type}
                options={[
